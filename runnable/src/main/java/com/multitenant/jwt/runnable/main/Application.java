package com.multitenant.jwt.runnable.main;
...
@ComponentScan(basePackages = { "com.multitenant.jwt.*" })
@EntityScan(basePackages = { "com.multitenant.jwt.*" })
@EnableMongoRepositories(basePackages = { "com.multitenant.jwt.*" })
